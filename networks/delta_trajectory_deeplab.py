...
class DeltaTrajectoryDeeplab(pl.LightningModule):
    def __init__(self,
            action_sigma,
            learning_rate=1e-3,
            weight_decay=None,
        ...
        n_features = 64
        self.net = DeepLabv3_feature(n_channels=4, n_features=n_features, os=8)
        self.outc = OutConv(in_channels=n_features, out_channels=1)
    ...
    def forward(self, input_trajectory, action_delta):
